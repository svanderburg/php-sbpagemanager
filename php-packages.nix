...
let
  packages = {
    ...
    "svanderburg/php-sbgallery" = {
      targetDir = "";
      src = fetchgit {
        name = "svanderburg-php-sbgallery-27b8b978db5b8a1334c615441b187c14217d32b1";
        url = "https://github.com/svanderburg/php-sbgallery.git";
        rev = "27b8b978db5b8a1334c615441b187c14217d32b1";
        sha256 = "1m2k4yylc0s01lx07g0mndg0w3wk2jjwrfzl11hq0hrc3glfdz4r";
      };
    };
