...
let
  packages = {
    ...
    "svanderburg/php-sbgallery" = {
      targetDir = "";
      src = fetchgit {
        name = "svanderburg-php-sbgallery-80a447e02637aacb20a194fa424c1c833ffc2431";
        url = "https://github.com/svanderburg/php-sbgallery.git";
        rev = "80a447e02637aacb20a194fa424c1c833ffc2431";
        sha256 = "1ri71nfak9cnni2jmxw9xrn433pk9k0kkchwzdskqlqqm4clgx3y";
      };
    };
